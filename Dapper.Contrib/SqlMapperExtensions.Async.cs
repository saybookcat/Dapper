...
namespace Dapper.Contrib.Extensions
{
    public static partial class SqlMapperExtensions
    {
        ...
        /// 获取行数
        /// </summary>
        public static async Task<int> GetRowCountAsync<T>(this IDbConnection connection, object entity = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            object enm =  await connection.ExecuteScalarAsync(sb.ToString(), param, transaction, commandTimeout: commandTimeout);
            if (enm == null)
            {
                return 0;
            }
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<bool> DeleteListAsync<T>(this IDbConnection connection, List<int> ids, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static async Task<bool> DeleteAsync<T>(this IDbConnection connection, object entity, IDbTransaction transaction = null, int? commandTimeout = null) where T : class
        {
            if (entity == null)
            {
            ...
            var deleted = await connection.ExecuteAsync(sb.ToString(), entity, transaction, commandTimeout).ConfigureAwait(false);
            return deleted > 0;
        }
